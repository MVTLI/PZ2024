...
5. Get winutils from [https://github.com/cdarlint/winutils/blob/master/hadoop-3.3.6/bin/winutils.exe]() and hadoop.dll from [https://github.com/cdarlint/winutils/blob/master/hadoop-3.3.6/bin/hadoop.dll]() and create a directory *C:\hadoop\bin.* Add HADOOP_HOME variable in your User Environment Variables with path: *C:\hadoop.*
